...
export default function Welcome({ auth, header, children }) {
    ...
    return (
        <>
                    ...
                    <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                        ...
                        <div className="pt-4 pb-1 border-t border-gray-200">
                            <div className="px-4">
                                ...
                                <div className="font-medium text-sm text-gray-500">register</div>
                            </div>
            ...
            {/* Old guestLayout
            <div className="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-b from-[#101212] relative to-[#08201D]">
                <div>
                    <Link href="/">
